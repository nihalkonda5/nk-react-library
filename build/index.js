...
function NkLocalizeText(_a) {
    ...
    return React__default.createElement(React__default.Fragment, null, textMap[language] || textMap[defaultLanguage] || textMap[Object.keys(textMap)[0]]);
}
...
function NkToast(_a) {
    ...
    return (React__default.createElement(Toast$1, { style: { minWidth: 300 }, onClose: function () { setShow(false); }, show: show, delay: disappearIn || 3000, autohide: true },
        React__default.createElement(Toast$1.Header, null,
            React__default.createElement("strong", { className: "mr-auto" }, title)),
...
function NkSimpleInput(_a) {
    ...
    return (React__default.createElement(FormImpl.Group, { style: {
        ...
        React__default.createElement(FormImpl.Label, null, label),
            ...
            prompt: function (data) {
                ...
                var promise = new Promise(function (resolve, reject) {
                    setData({
                        type: 'prompt',
                        title: data.title,
                        body: (React__default.createElement(NkSimpleInput, { id: '', type: '', label: data.description, defaultValue: data.defaultValue, valueChanged: function (id, value) { console.log(id, value); setValue(value); } })),
                        buttons: {
