import React, { useContext, useRef, useEffect, useCallback, useMemo, useState, forwardRef, useImperativeHandle, Component } from 'react';
...
function NkCard(_a) {
    ...
    return (React.createElement("div", null,
        React.createElement(Card, __assign({}, extraProps, cardProps), children)));
}
...
function MyPagination(_a) {
    ...
    var _loop_1 = function (i) {
        if (items[i] === -1) {
            ele[i] = React.createElement(Pagination.Ellipsis, { disabled: true });
        }
        else {
            ele[i] = (React.createElement(Pagination.Item, { key: items[i], active: items[i] === selectedPage, "data-page-value": items[i], onClick: function () {
...
function NkToastPanel() {
    ...
    return (React.createElement("div", { style: {
            ...
            top: 15 + scrollY,
            right: 10
        } }, toastList.map(function (toast) { return React.createElement(NkToast, { title: toast.title || '', body: toast.body || '', disappearIn: toast.disappearIn - new Date().getTime(), key: toast.disappearIn }); })));
}
...
function NkModal() {
            ...
            prompt: function (data) {
                ...
                var promise = new Promise(function (resolve, reject) {
                    setData({
                        type: 'prompt',
                        title: data.title,
                        body: (React.createElement(NkSimpleInput, { id: '', type: '', label: data.description, defaultValue: data.defaultValue, valueChanged: function (id, value) { console.log(id, value); setValue(value); } })),
                        buttons: {
    ...
    return (React.createElement(Modal$1, { show: show, onClose: function () {
        ...
        React.createElement(Modal$1.Footer, null,
            ...
            React.createElement(Button, { variant: data.buttons.positiveWarning ? "warning" : "primary", onClick: function () {
                    if (data.type === 'confirm') {
                        data.resolve(true);
                    }
                    else if (data.type === 'prompt') {
...
var NkRichTextEditor = /** @class */ (function (_super) {
    ...
    NkRichTextEditor.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(FormImpl.Group, { controlId: this.props.id },
                React.createElement(FormImpl.Label, null, this.props.label),
                React.createElement(lib, { id: this.props.id, style: {
                        maxWidth: 600
                    }, ref: function (el) {
                        //@ts-ignore
                        _this.quill = el;
                ...
                React.createElement(FormImpl.Text, { className: 'text-muted' }, this.props.description))));
    };
...
function NkFormElement(_a) {
    ...
    switch (elementConfig.type) {
        case 'rich-text':
            return React.createElement(NkRichTextEditor, __assign({}, elementConfig));
        case 'button':
        ...
        default:
            return React.createElement(NkSimpleInput, __assign({}, elementConfig));
    }
}
...
var MyForm = /** @class */ (function (_super) {
    ...
    MyForm.prototype.render = function () {
        var _this = this;
        return (React.createElement(FormImpl, { onSubmit: function (event) {
                event.preventDefault();
