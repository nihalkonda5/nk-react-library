...
var Modal$1 = React__default.forwardRef(function (_ref, ref) {
  ...
  var waitingForMouseUpRef = React.useRef(false);
  var ignoreBackdropClickRef = React.useRef(false);
  var removeStaticModalAnimationRef = React.useRef(null); // TODO: what's this type
  ...
  var modalContext = React.useMemo(function () {
    return {
      onHide: handleHide
    };
  }, [handleHide]);
...
var Toast = React__default.forwardRef(function (_ref, ref) {
  ...
  var toastContext = React.useMemo(function () {
    return {
      onClose: onClose
    };
  }, [onClose]);
...
function NkCard(_a) {
    var isLink = _a.isLink, to = _a.to, style = _a.style, cardProps = _a.cardProps, children = _a.children;
    var extraProps = {};
    if (isLink) {
        extraProps.as = reactRouterDom.Link;
        extraProps.style = __assign({ color: 'initial', textDecoration: 'initial', display: 'inline-block' }, style);
    ...
    return (React__default.createElement("div", null,
        React__default.createElement(Card, __assign({}, extraProps, cardProps), children)));
}
...
function NkImage(_a) {
    ...
    var _b = React__default.useState(false), error = _b[0], setError = _b[1];
    var _c = React__default.useState(__assign({}, style) || {}), _style = _c[0], setStyle = _c[1];
    var _d = React__default.useState({ width: 0, height: 0 }), dimensions = _d[0], setDimensions = _d[1];
    ...
    return (React__default.createElement("img", { style: _style, src: src, alt: alt || 'Basic Image', onError: function () {
            setError(true);
...
function NkButtonGroup(_a) {
    ...
    return (React__default.createElement(ButtonGroup, { id: id, style: {
        ...
        return (React__default.createElement(Button, { key: label, onClick: function () {
            ...
            React__default.createElement(NkLocalizeText, { text: label })));
    })));
}
...
function NkSubmitButton(_a) {
    ...
    return (React__default.createElement(Button, { className: inline ? 'd-inline' : '', variant: 'primary', type: 'submit', "data-id": id, style: { margin: 10 }, value: defaultValue, onClick: function () {
            valueChanged && valueChanged(id, defaultValue);
        } },
        React__default.createElement(NkLocalizeText, { text: label || 'Submit' })));
}
...
function NkSimpleInput(_a) {
    ...
    return (React__default.createElement(FormImpl.Group, { style: {
        ...
        React__default.createElement(FormImpl.Label, null,
            React__default.createElement(NkLocalizeText, { text: label || '' })),
        React__default.createElement(FormImpl.Control, __assign({ style: { maxWidth: 600 } }, attrs, { id: id, placeholder: placeholder, defaultValue: defaultValue, required: required || false, onChange: function (event) {
...
function NkSimpleButton(_a) {
    ...
    return (React__default.createElement(Button, { className: inline ? 'd-inline' : '', variant: 'primary', type: 'button', "data-id": id, onClick: function () {
            formButtonClicked && formButtonClicked(id);
        }, style: { margin: 10 } },
        React__default.createElement(NkLocalizeText, { text: label || 'Button' })));
}
...
var NkRichTextEditor = /** @class */ (function (_super) {
    ...
    NkRichTextEditor.prototype.render = function () {
        var _this = this;
        ...
        return (React__default.createElement("div", null,
            React__default.createElement(FormImpl.Group, { controlId: this.props.id },
                ...
                React__default.createElement(lib, { id: this.props.id, style: {
                    ...
                    }, theme: 'snow', defaultValue: this.props.defaultValue || '', onChange: function (content) {
                        // console.log(content,delta,source);
                        _this.props.valueChanged && _this.props.valueChanged(_this.props.id, content);
                    }, modules: {
                        magicUrl: true,
                        toolbar: {
                            container: [
                            ...
                            handlers: {
                                image: function () {
                                    //@ts-ignore
                                    _this.lastSelectionRange = _this.quill
                                        .getEditor()
                                        .getSelection();
...
function NkDropdown(_a) {
    ...
    return (React__default.createElement(FormImpl.Group, { style: {
        ...
        React__default.createElement(FormImpl.Control, { style: { maxWidth: 600 }, id: id, as: "select", defaultValue: defaultValue, required: required || false, onChange: function (event) {
                valueChanged && valueChanged(id, event.target.value);
            } }, valueList === null || valueList === void 0 ? void 0 : valueList.map(function (v) { return React__default.createElement("option", { value: v.value, selected: v.value === defaultValue },
...
function NkFormElement(_a) {
    ...
    switch (elementConfig.type) {
        case 'rich-text':
            return React__default.createElement(NkRichTextEditor, __assign({}, elementConfig));
        case 'button':
...
function paginationPattern(selectedPage, totalPages, padding) {
    ...
    var leadingEllipsis = selectedPage > padding + 2;
    var trailingEllipsis = selectedPage < totalPages - (padding + 2);
    items.push(1);
    if (leadingEllipsis)
        items.push(-1);
    for (var i = Math.max(selectedPage - 2, 2); i <= selectedPage + 2; i++) {
        if (i > totalPages)
            return items;
        items.push(i);
        if (i === totalPages)
...
function arrayRange(lowEnd, highEnd) {
    if (lowEnd === void 0) { lowEnd = 1; }
    if (highEnd === void 0) { highEnd = 10; }
    var list = [];
...
function MyPagination(_a) {
    ...
    var _loop_1 = function (i) {
        if (items[i] === -1) {
            ele[i] = React__default.createElement(Pagination.Ellipsis, { disabled: true });
        }
        else {
            ele[i] = (React__default.createElement(Pagination.Item, { key: items[i], active: items[i] === selectedPage, "data-page-value": items[i], onClick: function () {
...
function NkRichTextContainer(_a) {
    var html = _a.html;
    return (React__default.createElement("div", { className: 'quill ql-editor ql-container', dangerouslySetInnerHTML: { __html: html } }));
}
...
var NkStateManagerUtils = /** @class */ (function () {
    ...
    NkStateManagerUtils.prototype.addStateListener = function (key, listener) {
    ...
    NkStateManagerUtils.prototype.setStateValue = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                this.backupState();
                if (this.stateListeners[key]) {
                    this.stateListeners[key].forEach(function (l) { return l(key, value); });
                }
                return [2 /*return*/];
            });
        });
...
RedirectableRequest.prototype._processResponse = function (response) {
  ...
  if (location && this._options.followRedirects !== false &&
    ...
    debug_1$1("redirecting to", redirectUrl);
...
var name="axios";var version="0.21.0";var description="Promise based HTTP client for the browser and node.js";var main="index.js";var scripts={test:"grunt test && bundlesize",start:"node ./sandbox/server.js",build:"NODE_ENV=production grunt build",preversion:"npm test",version:"npm run build && grunt version && git add -A dist && git add CHANGELOG.md bower.json package.json",postversion:"git push && git push --tags",examples:"node ./examples/server.js",coveralls:"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js",fix:"eslint --fix lib/**/*.js"};var repository={type:"git",url:"https://github.com/axios/axios.git"};var keywords=["xhr","http","ajax","promise","node"];var author="Matt Zabriskie";var license="MIT";var bugs={url:"https://github.com/axios/axios/issues"};var homepage="https://github.com/axios/axios";var devDependencies={bundlesize:"^0.17.0",coveralls:"^3.0.0","es6-promise":"^4.2.4",grunt:"^1.0.2","grunt-banner":"^0.6.0","grunt-cli":"^1.2.0","grunt-contrib-clean":"^1.1.0","grunt-contrib-watch":"^1.0.0","grunt-eslint":"^20.1.0","grunt-karma":"^2.0.0","grunt-mocha-test":"^0.13.3","grunt-ts":"^6.0.0-beta.19","grunt-webpack":"^1.0.18","istanbul-instrumenter-loader":"^1.0.0","jasmine-core":"^2.4.1",karma:"^1.3.0","karma-chrome-launcher":"^2.2.0","karma-coverage":"^1.1.1","karma-firefox-launcher":"^1.1.0","karma-jasmine":"^1.1.1","karma-jasmine-ajax":"^0.1.13","karma-opera-launcher":"^1.0.0","karma-safari-launcher":"^1.0.0","karma-sauce-launcher":"^1.2.0","karma-sinon":"^1.0.5","karma-sourcemap-loader":"^0.3.7","karma-webpack":"^1.7.0","load-grunt-tasks":"^3.5.2",minimist:"^1.2.0",mocha:"^5.2.0",sinon:"^4.5.0",typescript:"^2.8.1","url-search-params":"^0.10.0",webpack:"^1.13.1","webpack-dev-server":"^1.14.1"};var browser$1={"./lib/adapters/http.js":"./lib/adapters/xhr.js"};var jsdelivr="dist/axios.min.js";var unpkg="dist/axios.min.js";var typings="./index.d.ts";var dependencies={"follow-redirects":"^1.10.0"};var bundlesize=[{path:"./dist/axios.min.js",threshold:"5kB"}];var _package = {name:name,version:version,description:description,main:main,scripts:scripts,repository:repository,keywords:keywords,author:author,license:license,bugs:bugs,homepage:homepage,devDependencies:devDependencies,browser:browser$1,jsdelivr:jsdelivr,unpkg:unpkg,typings:typings,dependencies:dependencies,bundlesize:bundlesize};
...
function NkToast(_a) {
    ...
    var _b = React__default.useState(true), show = _b[0], setShow = _b[1];
    if (!disappearIn || disappearIn <= 0)
        return React__default.createElement("span", null);
    return (React__default.createElement(Toast$1, { style: { minWidth: 300 }, onClose: function () { setShow(false); }, show: show, delay: disappearIn || 3000, autohide: true },
        React__default.createElement(Toast$1.Header, null,
            React__default.createElement("strong", { className: "mr-auto" },
                React__default.createElement(NkLocalizeText, { text: title }))),
        React__default.createElement(Toast$1.Body, null, (body || '').split('\n').map(function (s, i) { return React__default.createElement("span", { key: i },
            React__default.createElement(NkLocalizeText, { text: s }),
...
function NkToastPanel() {
    ...
    return (React__default.createElement("div", { style: {
            ...
            top: 15 + scrollY,
            right: 10
        } }, toastList.map(function (toast) { return React__default.createElement(NkToast, { title: toast.title || '', body: toast.body || '', disappearIn: toast.disappearIn - new Date().getTime(), key: toast.disappearIn }); })));
}

var distModules = createCommonjsModule(function (module, exports) {
...
var geolocated = function geolocated() {
  ...
  return function (WrappedComponent) {
    ...
    var result = (_temp = /*#__PURE__*/function (_Component) {
...
unwrapExports(distModules);
var distModules_1 = distModules.geoPropTypes;
var distModules_2 = distModules.geolocated;

var NkLocationLoader = /** @class */ (function (_super) {
    __extends(NkLocationLoader, _super);
    function NkLocationLoader() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NkLocationLoader.prototype.render = function () {
        return React__default.createElement("span", null);
    };
    return NkLocationLoader;
}(React__default.Component));
...
function NkModal() {
    ...
    return (React__default.createElement(Modal$1, { show: show, onClose: modalResponse(null), onHide: modalResponse(null) },
        React__default.createElement(Modal$1.Header, { closeButton: true, onHide: modalResponse(null) },
            React__default.createElement(Modal$1.Title, null,
                React__default.createElement(NkLocalizeText, { text: data.title || 'Untitled' }))),
        data.body && React__default.createElement(Modal$1.Body, null, data.body),
        React__default.createElement(Modal$1.Footer, null,
            data.buttons.hasNegativeButton && React__default.createElement(Button, { variant: "secondary", onClick: modalResponse(false) },
                React__default.createElement(NkLocalizeText, { text: data.buttons.negativeLabel || 'Cancel' })),
            React__default.createElement(Button, { variant: data.buttons.positiveWarning ? "danger" : "primary", onClick: modalResponse(true) },
                React__default.createElement(NkLocalizeText, { text: data.buttons.positiveLabel || 'Submit' })))));
}
...
var MyForm = /** @class */ (function (_super) {
    ...
    MyForm.prototype.render = function () {
        ...
        return (React__default.createElement(FormImpl, { onSubmit: function (event) {
            ...
            React__default.createElement("h3", null, this.props.title),
            React__default.createElement("p", { className: 'text-muted' }, this.props.description),
